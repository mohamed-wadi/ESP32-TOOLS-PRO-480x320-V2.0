...
Multi-tool firmware for ESP32 Dev Module with TFT SPI 480x320 display. This V2.0 version adds real support for external IR and CC1101 modules, new WiFi/BLE tools, saveable IR capture and replay, sub-GHz RF analysis, and a more polished interface for personal lab use.

> Use this firmware only on your own networks, your own devices, and environments where you have authorization. Several functions can scan, transmit, interfere with, or copy signals. The goal of this project is learning, diagnostics, and personal lab use.
>
...
> [![Instagram](https://img.shields.io/badge/Instagram-pepeangell1-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/pepeangell1)
...
>                                                                                                           - - Renewed Jammer in Radio Tools for 2.4 GHz tests with dual nRF24L01.
...
>                                                                                                                       - - Updated Splash with cleaner text animation and BWifiKill branding.
>                                                                                                                         - - Menus with less flickering, remembered cursor position on return, and clearer diagnostic screens.
...
> - TFT SPI 480x320 display with ILI9488 driver.
...
>         - - Cables, solder, headers, and common GND for all modules.
>          
...
>             > | Front view | ![Front view ESP32-TOOLS-PRO](img/pro2.JPG) |
>             > | Side view | ![Side view](img/pro3.JPG) |
>             > | Internal view / assembly | ![Internal view](img/pro4.JPG) |
>             >
>             > [Back to index](#table-of-contents)
>             >
...
> - - **Channel Scan**: groups networks by channel, shows how many networks are on each channel, and allows opening the AP list by channel.
...
>           - - **Deauther**: WiFi test tool for authorized environments.
...
>                 - - **KARMA Attack**: educational mode to understand probe responses and insecure associations.
>                  
>                   - > **Important limitation**: the classic ESP32 only works with 2.4 GHz WiFi. It cannot scan 5 GHz networks.
>                     >
>                     > ### Radio Tools
>                     >
>                     > - **Jammer**: renewed mode for 2.4 GHz tests in personal lab. Lets you choose a WiFi channel, start/stop with OK, and uses both nRF24L01 modules when available.
...
>                     >       - ### Signal Tools / IR
>                     >      
>                     >       - - **Hardware Diag**: shows pins, SPI status, RX levels, and general hardware state.
...
>                     >                         - - **IR Sniffer**: logs live IR events with protocol, code, bits, duration, and repeats.
...
>                     >                              
>                     >                               - > **IR Notes:**
>                     >                                 > > - Many mini-split/AC units use long codes with full state. Raising temperature, lowering temperature, turning on, and turning off can be completely different captures.
>                     >                                 > > - > - The demodulated IR receiver does not measure real analog intensity or exact carrier frequency. The bars are detected activity, not precise optical power.
...
>                     >                                 > >   >   >   - - **Spectrum Scan**: sweeps common bands 315, 433, 868, and 915 MHz to show RSSI peaks.
...
>                     >                                 > >   >   >             - - **Code Check**: compares multiple presses to see if a signal appears fixed or rolling.
...
>                     >                                 > >   >   >                        
>                     >                                 > >   >   >                         - > **CC1101 Notes:**
>                     >                                 > >   >   >                           > > - 433.92 MHz and 434 MHz normally refer to the same practical range. Many remotes are advertised as 434 MHz but work near 433.92 MHz.
>                     >                                 > >   >   >                           > > - > - The frequency meter is approximate. It does not replace a professional spectrum analyzer.
>                     >                                 > >   >   >                           > >   > - > - Do not use RF replay on cars, gates, alarms, locks, or third-party systems. Many use rolling codes and should not be copied or tested outside your own lab.
>                     >                                 > >   >   >                           > >   >   >
>                     >                                 > >   >   >                           > >   >   > - ### Bluetooth Tools
>                     >                                 > >   >   >                           > >   >   >
...
>                     >                                 > >   >   >                           > >   >   >       - - **BLE Spam**: educational BLE tests in lab.
>                     >                                 > >   >   >                           > >   >   >         - - **BT Disruptor**: controlled lab Bluetooth tests.
>                     >                                 > >   >   >                           > >   >   >           - - **BT Jammer**: 2.4 GHz sweep with dual nRF24L01 for short-range educational tests in personal lab.
>                     >                                 > >   >   >                           > >   >   >            
>                     >                                 > >   >   >                           > >   >   >             - ### System Tools
>                     >                                 > >   >   >                           > >   >   >            
>                     >                                 > >   >   >                           > >   >   >             - - **Settings**: device configuration and saved options.
>                     >                                 > >   >   >                           > >   >   >               - - **System Info**: memory, firmware, and ESP32 status information.
>                     >                                 > >   >   >                           > >   >   >                 - - **Clock & Weather**: clock/weather with virtual keyboard for configuration.
...
> - Quick diagnostics of IR RX levels and CC1101 GDO0.
...
> |-----------|-------------|---------------------|-------|
> | ESP32 Dev Module | Main microcontroller of the project | USB/5V on board | GPIO logic at 3.3V |
...
> | Component | Image |
> |-----------|-------|
> | ESP32 Dev Module | ![ESP32 Dev Module](img/esp32.jpg) |
> | ILI9488 480x320 Display | ![ILI9488 display](img/tft.jpg) |
> | nRF24L01 Modules | ![nRF24L01](img/nrf1.jpg) |
> | nRF24L01 | ![nRF24L01](img/nrf2.jpg) |
> | CC1101 | ![CC1101](img/cc1101.jpg) |
> | Antenna | ![Antenna](img/antena.jpg) |
> | M5Stack IR Unit | ![M5Stack IR Unit](img/ir1.jpg) |
> | IR Unit view 2 | ![IR Unit view 2](img/ir2.jpg) |
> | Buttons | ![Buttons](img/botones.jpg) |
> | Battery | ![Battery](img/bateria.jpg) |
> | TP4056 | ![TP4056](img/tp4056.jpg) |
> | Step-up | ![Step-up](img/stepup.jpg) |
> | Switch | ![Switch](img/interruptor.jpg) |
> | PCB board / assembly | ![PCB board](img/pcb.jpg) |
>
> ### Full Wiring Diagrams
>
> These diagrams show the wiring by blocks to make it easier to solder and review the assembly without overloading a single image.
>
> **TFT display and buttons**
>
> ![TFT and buttons wiring](img/diagram1.jpg)
>
> **nRF24L01 modules**
>
> ![nRF24L01 wiring](img/diagram2.jpg)
>
> **CC1101 and IR Remote**
>
> ![CC1101 and IR wiring](img/diagram3.jpg)
>
> ### Reference Pinouts
>
> | Module | Pinout |
> |--------|--------|
> | nRF24L01 PA + LNA | ![nRF24L01 pinout](img/pinout_nrf.jpg) |
> | CC1101 | ![CC1101 pinout](img/pinout_cc1101.jpg) |
>
> [Back to index](#table-of-contents)
>
> ## Connection Table
...
> | 5V | 5V | Power supply | M5Stack IR module works at 5V |
> | GND | GND | Common ground | Sharing ground is mandatory |
>
> > GPIO34 is input-only, that's why it's used for receiving IR. GPIO26 is used for transmitting.
>
> ### CC1101
>
...
> | MOSI / SI | GPIO23 | Shared SPI | ESP32 to CC1101 data |
> | MISO / SO | GPIO19 | Shared SPI | CC1101 to ESP32 data |
...
> | GND | GND | Common ground | Sharing ground is mandatory |
>
> > The extra GDO0 -> GPIO15 jumper is only needed for Lab Replay tests. You can skip it if you will only use diagnostics, monitor, finder, analyzer, and raw view.
>
> ### Buttons
>
...
>
> ![Visual wiring diagram](img/diagram_full.jpg)
>
> [Back to index](#table-of-contents)
>
> ### Quick Pin Map
...
> ```
>
> > If the upload fails with a boot/serial error, hold down BOOT when starting the upload and release it when PlatformIO starts writing.
>
> [Back to index](#table-of-contents)
>
> ## Known Limitations
...
> - IR Proximity is experimental and may stay at NONE depending on angle and physical bounce.
> - Air conditioners usually use long signals with full state; save each function separately.
...
> - Lab Replay RF is intended for light bulbs, plugs, or your own fixed-code devices. It is not for vehicles, alarms, locks, or gates.
> - RF433T/RF433R modules are not included in V2.0.
>
> [Back to index](#table-of-contents)
>
> ## Credits
